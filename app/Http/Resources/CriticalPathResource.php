...
class CriticalPathResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return $this->filter([
            ...
            "Production Sample & Shipping Approval Information"              => isset($this->sampleShippingInfo) ?(new SampleApprovalInformationResource($this->sampleShippingInfo))->hide(["created_by","updated_by"]) : null,
            "Ex-Factory, ETA & Vessel Information"              => isset($this->exFactoryInfo) ?(new ExFactoryResource($this->exFactoryInfo))->hide(["created_by","updated_by"]) : null,
            "Payment Information"              => isset($this->paymentInfo) ?(new PaymentResource($this->paymentInfo))->hide(["created_by","updated_by"]) : null,
