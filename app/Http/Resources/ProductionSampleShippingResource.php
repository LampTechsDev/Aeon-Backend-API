...
class ProductionSampleShippingResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return $this->filter([
            ...
            "development_photo_sample_sent_plan_buyer"    => $this->development_photo_sample_sent_plan_buyer ?? "",
            ...
            "development_photo_sample_dispatch_sending_date"   => $this->development_photo_sample_dispatch_sending_date ?? "",
            "development_photo_sample_dispatch_awb_number"     => $this->development_photo_sample_dispatch_awb_number ?? "",
            "development_photo_sample_dispatch_review_meeting" => $this->development_photo_sample_dispatch_review_meeting ?? "",
            "fit_sample_review_meeting"                        => $this->fit_sample_review_meeting ?? "",
            "size_set_sample_review_meeting"                   => $this->size_set_sample_review_meeting ?? "",
            "pp_sample_review_meeting"                         => $this->pp_sample_review_meeting ?? "",
            "fit_approval_plan"                           => $this->fit_approval_plan ?? "",
            "fit_approval_plan_buyer"                     => $this-> fit_approval_plan_buyer ?? "",
            ...
            "size_set_approval_plan_buyer"                => $this->size_set_approval_plan_buyer ?? "",
            ...
            "pp_approval_plan_buyer"                      => $this->pp_approval_plan_buyer ?? "",
