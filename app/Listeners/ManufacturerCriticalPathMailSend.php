...
class ManufacturerCriticalPathMailSend
{
    /**
    ...
    {
        $model = $event->model;
        $user = $model->poId->manufacturer;
        $email_template = "";
        $email_template =  EmailTemplate::where("email_type", "manufacturer_critical_mail")->orderBy("id", "DESC")->first();
