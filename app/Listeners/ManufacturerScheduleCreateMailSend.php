...
class ManufacturerScheduleCreateMailSend
{
    /**
    ...
    {
        $model = $event->model;
        $user = $model->poDetails->manufacturer;
        $email_template = "";
        $email_template =  EmailTemplate::where("email_type", "manufacturer_create_schedule_mail")->orderBy("id", "DESC")->first();
