...
class VendorScheduleCreateMailSend
{
    /**
    ...
    {
        $model = $event->model;
        $user = $model->poDetails->vendor;
        $email_template = "";
        $email_template =  EmailTemplate::where("email_type", "vendor_create_schedule_mail")->orderBy("id", "DESC")->first();
