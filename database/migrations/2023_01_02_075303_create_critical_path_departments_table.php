...
class CreateCriticalPathDepartmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('critical_path_departments', function (Blueprint $table) {
            $table->id();
            $table->string("name");
            $table->integer("days");
            $table->string("status");
    ...
    {
        Schema::dropIfExists('critical_path_departments');
    }
}
