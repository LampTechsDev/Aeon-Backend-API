...
class CreateSewingReportUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sewing_report_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sewing_report_uploads');
    }
}
