...
class CreateFinishingReportUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('finishing_report_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('finishing_report_uploads');
    }
}
