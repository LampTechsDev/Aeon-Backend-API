...
class CreateFinalAqlReportUploadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('final_aql_report_uploads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('final_aql_report_uploads');
    }
}
